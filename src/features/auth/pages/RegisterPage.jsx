  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 py-8">
      <div className="w-full max-w-5xl flex rounded-2xl shadow-2xl overflow-hidden bg-white">
        ...
        <AuthSidePanel
          title="Membangun jembatan komunikasi yang transparan antara warga dan pemerintah desa untuk masa depan yang lebih baik."
        />
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="noWhatsapp">
                  Nomor WhatsApp
                </label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <div className="flex items-start gap-3 pt-1">
              ...
              <label htmlFor="agreed" className="text-xs text-gray-600 cursor-pointer leading-relaxed">
                Saya menyetujui{' '}
                <a href="#" className="text-blue-600 font-medium hover:underline">Syarat dan Ketentuan</a>
                {' '}serta{' '}
          ...
          <div className="mt-6 pt-5 border-t border-gray-100 flex justify-center gap-6">
            <a href="#" className="text-xs text-gray-400 hover:text-gray-600 transition-colors">Pusat Bantuan</a>
            <a href="#" className="text-xs text-gray-400 hover:text-gray-600 transition-colors">Panduan Registrasi</a>
            <a href="#" className="text-xs text-gray-400 hover:text-gray-600 transition-colors">Kontak Kami</a>
          </div>
        </div>
      </div>
