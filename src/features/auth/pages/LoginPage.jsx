  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-5xl flex rounded-2xl shadow-2xl overflow-hidden bg-white">
        ...
        <AuthSidePanel
          title={<>Layanan Administrasi<br />Denpasar</>}
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-12">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 mb-1">Selamat Datang Kembali</h2>
          ...
          <div className="flex items-center my-6">
            ...
            <span className="px-4 text-xs font-semibold text-gray-400 tracking-widest uppercase">Atau</span>
            <div className="flex-1 h-px bg-gray-200"></div>
          </div>
      ...
      <div className="fixed bottom-12 right-4 bg-white/95 backdrop-blur-sm border border-gray-200 shadow-xl rounded-xl p-4.5 z-50 space-y-2.5 max-w-xs">
        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Debug Switcher (Bypass Login)</p>
