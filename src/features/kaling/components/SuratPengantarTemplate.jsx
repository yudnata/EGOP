    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[95vh] flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between flex-shrink-0 print:hidden">
          <div>
            <h2 className="text-sm font-bold text-gray-900">Preview Surat Pengantar</h2>
            <p className="text-[10px] text-gray-400">Surat ini akan diterbitkan atas nama Kepala Lingkungan</p>
          </div>
        ...
        <div className="overflow-y-auto flex-1 p-6 print:p-0">
          <div
            ...
            style={{ maxWidth: '210mm', minHeight: '297mm', padding: '20mm 25mm', fontFamily: 'Times New Roman, serif' }}
          >
            {/* Kop Surat */}
            <div className="text-center border-b-2 border-black pb-3 mb-6">
              <p className="text-[10px] font-bold tracking-widest uppercase" style={{ fontSize: '10pt' }}>
                PEMERINTAH KOTA DENPASAR
              </p>
              <p className="text-[10px] font-bold tracking-widest uppercase" style={{ fontSize: '10pt' }}>
                KECAMATAN DENPASAR SELATAN
              </p>
              <p className="font-bold tracking-wide uppercase" style={{ fontSize: '14pt' }}>
                KELURAHAN PANJER
              </p>
            ...
            <div className="text-center mb-6">
              <p className="font-bold underline uppercase" style={{ fontSize: '13pt' }}>
                SURAT PENGANTAR
              </p>
              <p style={{ fontSize: '10pt' }}>
                Nomor: {data?.nomorSurat || '070/SP/'}{String(today.getMonth() + 1).padStart(2, '0')}/{today.getFullYear()}
              </p>
            </div>
            ...
            <div style={{ fontSize: '11pt', lineHeight: '1.8' }}>
              <p className="mb-4">
                Yang bertanda tangan di bawah ini, Kepala Lingkungan / Kelian Banjar {data?.banjar || 'Tegal'},
                Kelurahan Panjer, Kecamatan Denpasar Selatan, Kota Denpasar, menerangkan bahwa:
              </p>
              ...
              <table className="mb-4" style={{ fontSize: '11pt' }}>
                <tbody>
                  <tr>
                    <td className="pr-4 py-1 align-top" style={{ width: '180px' }}>Nama Lengkap</td>
                    <td className="pr-2 py-1 align-top">:</td>
                    <td className="py-1 font-bold uppercase">{data?.nama || 'BUDI SANTOSO'}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="pr-2 py-1 align-top">:</td>
                    <td className="py-1">{data?.ttl || 'Denpasar, 12 April 1992'}</td>
                  </tr>
                  <tr>
                    <td className="pr-4 py-1 align-top">Jenis Kelamin</td>
                    <td className="pr-2 py-1 align-top">:</td>
                    <td className="py-1">{data?.jenisKelamin || 'Laki-laki'}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="pr-2 py-1 align-top">:</td>
                    <td className="py-1">{data?.pekerjaan || 'Karyawan Swasta'}</td>
                  </tr>
                  <tr>
                    <td className="pr-4 py-1 align-top">Alamat</td>
                    <td className="pr-2 py-1 align-top">:</td>
                    <td className="py-1">{data?.alamat || 'Jl. Kamboja No. 5, Banjar Tegal, Kel. Panjer, Denpasar Selatan'}</td>
                  </tr>
                </tbody>
              </table>

              <p className="mb-4">
                Adalah benar warga kami yang berdomisili di wilayah Lingkungan / Banjar {data?.banjar || 'Tegal'},
                Kelurahan Panjer. Surat pengantar ini diberikan untuk keperluan:
              </p>

              <p className="font-bold mb-4 px-4 py-2 border border-gray-400 rounded" style={{ fontSize: '12pt' }}>
                {data?.keperluan || data?.jenisSurat || 'Pengurusan Surat Keterangan Domisili'}
              </p>

              <p className="mb-8">
                Demikian surat pengantar ini dibuat dengan sebenar-benarnya untuk dapat dipergunakan sebagaimana mestinya.
              </p>
            </div>
            ...
            <div className="flex justify-end" style={{ fontSize: '11pt' }}>
              <div className="text-center" style={{ width: '250px' }}>
                ...
                <p className="font-bold underline uppercase">{data?.namaKaling || 'I MADE HERMAN'}</p>
              </div>
            </div>
          </div>
        </div>
